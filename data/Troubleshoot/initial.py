...
if __name__ == '__main__':
    ...
    # parser.add_argument('--fundats-file', type=str,default='/home/maria/Improving_Summaries/pkl_files/clean_data_gpt.pkl')
    parser.add_argument('--fundats-file', type=str,
                        default='Troubleshoot_axis_after_human_study.pkl')
    ...
    for partnum in range(0, 1):
        ...
        for fid in tqdm(fundats_fids):
            ...
            with open(f'tmp/{fid}', 'w') as f:
                func = fundats[fid][0][0]  # fundats[fid]['code']  # fundats[fid][0][0]
                summ = fundats[fid][0][1]  # fundats[fid]['summary']  # fundats[fid][0][1]
                prompt = func + summ
                # print(prompt)
                f.write(prompt)
