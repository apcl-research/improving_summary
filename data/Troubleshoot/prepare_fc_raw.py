...
if __name__ == '__main__':
    ...
    parser.add_argument('--coms-file', type=str, default='/home/maria/Improving_Summaries/pkl_files/summary_selection_gpt-4o_mini.pkl')
    ...
    fundats_fids = [int(key) for key in coms.keys()]
    pt = int(len(fundats_fids) * 0.5)
    count = 0
    count_val = 0

    #Loop range should cover all data pt% * range ==1
