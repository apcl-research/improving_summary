...
if __name__ == '__main__':
    ...
    parser.add_argument('--fundats-file', type=str,default='/home/maria/Improving_Summaries/pkl_files/train_human_condensing.pkl')
    ...
    codes = pickle.load(open('/nublar/datasets/jm52m/fundats-j1.pkl', 'rb'))
    ...
    for partnum in range(0, 1):
        ...
        for fid in tqdm(fundats_fids):
            ...
            with open(f'tmp/{fid}', 'w') as f:
                func = codes[fid]
                summ = fundats[fid]['summary']
                #func = fundats[fid][0]  # fundats[fid][0][0]
                #summ = fundats[fid][1]  # fundats[fid][0][1]
                prompt = func + summ
                print(prompt)
                # f.write(prompt)
                f.write(f'TDAT:\t{func}\nCOM:\t{summ}')
