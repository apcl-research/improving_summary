...
eval_iters = 80
wandb_log = True
wandb_project = 'jam-cgpt-fine-tuning-Contextualizing-Axis'
wandb_run_name = 'jam-cgpt-fine-tuning-model_human-contextualizing_epoch5'

dataset = 'Contextualizing'
init_from = 'resume'
